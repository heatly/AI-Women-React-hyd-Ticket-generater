  ...
  return (
    <div className="app-container">
      ...
      <header style={{ marginTop: '1rem', textAlign: 'center' }}>
        <h1 style={{ fontSize: '2.8rem', fontWeight: 800, marginBottom: '0.5rem' }}>AI CONCLAVE</h1>
        <p style={{ color: 'white', fontWeight: 500, letterSpacing: '2px', marginBottom: '0.5rem' }}>WOMEN'S EDITION</p>
        <p style={{ fontStyle: 'italic', fontSize: '0.9rem', color: 'var(--text-secondary)', marginBottom: '2.5rem' }}>
          🚀 Participate to win exclusive React Hyderabad goodies!
        </p>
      </header>
